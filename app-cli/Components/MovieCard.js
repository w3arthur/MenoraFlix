...
return (<Box style={{flexDirection: 'row', height: '100%'}}>
  <Box style={{flex: 1, margin: 7,}}><ImageBackground source={{ uri: movie.image }} resizeMode="cover" style={{justifyContent: "space-around", flex: 1}} imageStyle={{ borderRadius: 5}}></ImageBackground></Box>
